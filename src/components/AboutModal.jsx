                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-gray-50 p-5 rounded-xl border border-gray-200">
                                    ...
                                    <ul className="list-disc list-inside text-sm text-gray-600 space-y-1 ml-1">
                                        ...
                                        <li><strong>Bias Awareness:</strong> เราตระหนักถึงอคติที่อาจแฝงมากับโมเดลภาษา จึงมีการออกแบบ Prompt เพื่อให้ AI วิเคราะห์ตามหลักการสิทธิมนุษยชนสากลอย่างเป็นกลางที่สุด</li>
                                    </ul>
                                </div>
                            </div>
                        </section>
